...
## SUBSET
the.data <- the.data[, !colnames(the.data) %in% c('CASE06_LE-NOXFS','CASE09_LE-NOXFS','CASE07','CASE08','CASE09',
                                                  'CASE12','CASE15', 'CASE17',
                                                  'CASE19','CASE20','CASE21','CASE22','CASE25','CASE07_RE_NOXFS',
                                                  'CASE32','CASE33','CASE36',
                                                  'CASE38','CASE39')]
the.coldata <- the.coldata[!row.names(the.coldata) %in% c('CASE06_LE-NOXFS','CASE09_LE-NOXFS','CASE07','CASE08','CASE09',
                                                          'CASE12','CASE15','CASE17',
                                                          'CASE19','CASE20','CASE21','CASE22','CASE25','CASE07_RE_NOXFS',
                                                          'CASE32','CASE33','CASE36',
                                                          'CASE38','CASE39'),]
