...
## SUBSET
the.data <- the.data[, !colnames(the.data) %in% c('CASE06_LE-NOXFS','CASE09_LE-NOXFS','CASE15_RE_XFS','CASE22_RE_XFS','CASE06','CASE11','CASE07_RE_NOXFS','CASE27','CASE28')]
the.coldata <- the.coldata[!row.names(the.coldata) %in% c('CASE06_LE-NOXFS','CASE09_LE-NOXFS','CASE15_RE_XFS','CASE22_RE_XFS','CASE06','CASE11','CASE07_RE_NOXFS','CASE27','CASE28'),]
