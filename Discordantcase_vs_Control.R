...
## ASSIGN SAMPLE NAMES
new_names <- c('CASE06_LE-NOXFS','CASE09_LE-NOXFS','CTRL03','CTRL04','CTRL05','CASE06_RE-XFS','CASE07_LE-XFG','CASE08','CASE09_RE-XFG',
               'CTRL10','CASE11','CASE12','CTRL13','CTRL14','CASE15_LE-XFG','CTRL16','CASE17','CTRL18',
               'CASE19','CASE20','CASE21','CASE22_RE-XFS','CASE22_LE-XFG','CTRL24','CASE25','CASE07_RE-NOXFS','CASE27',
               'CASE28','CTRL29','CASE15_RE-XFS','CTRL31','CASE32','CASE33','CTRL34','CTRL35','CASE36',
...
compare.COMP <- list(c('CTRL03','CTRL04','CTRL05','CTRL10','CTRL13','CTRL14','CTRL16','CTRL18','CTRL24','CTRL29','CTRL31','CTRL34','CTRL35','CTRL37','CTRL40'),
                     c('CASE06_LE-NOXFS','CASE09_LE-NOXFS','CASE06_RE-XFS','CASE07_LE-XFG','CASE08','CASE09_RE-XFG',
                       'CASE11','CASE12','CASE15_LE-XFG','CASE17',
                       'CASE19','CASE20','CASE21','CASE22_RE-XFS','CASE22_LE-XFG','CASE25','CASE07_RE-NOXFS','CASE27',
                       'CASE28','CASE15_RE-XFS','CASE32','CASE33','CASE36',
                       'CASE38','CASE39'))

## SAMPLE CONRITION
condition <- factor(c(rep('case',25),rep('ctrl',15))) ## MUST AUTOMATE - USER INPUT MAYBE
sex <- factor(c('M','M','M','M','F','M','M','F','F','M','M','F','M','M','M','F','F','M','F','M','M','F','M','M','F','M','F','F','F','F','F','F','F','M','F','M','M','F','F','M'))
age <- c('53','53','63','63','45','53','53','76','67','80','80','80','69','62','58','84','84','71','87','85','73','74','66','74','77','51','78','58','75','67','58','81','83','78','69','71','78','55','67','64')
the.coldata <- DataFrame(row.names=colnames(the.data), condition, sex, age)

## SUBSET
the.data <- the.data[, !colnames(the.data) %in% c('CASE08','CASE11','CASE12','CASE17','CASE19','CASE20','CASE21','CASE25','CASE27',
                                                  'CASE28','CASE32','CASE33','CASE36',
                                                  'CASE38','CASE39')]
the.coldata <- the.coldata[!row.names(the.coldata) %in% c('CASE08','CASE11','CASE12','CASE17','CASE19','CASE20','CASE21','CASE25','CASE27',
                                                          'CASE28','CASE32','CASE33','CASE36',
                                                          'CASE38','CASE39'),]
...
res.COMP <- results(dds.COMP, alpha=0.05, lfcThreshold=0.6, altHypothesis="greaterAbs")
summary(res.COMP)
sum(res.COMP$padj < 0.05, na.rm=TRUE)

sig.COMP <- get_sig(res.COMP, 0.05, 0.6)
